...
from etl_web_to_gcs_parametize_4 import etl_web_to_gcs  # pylint: disable=import-error
...
docker_dep = Deployment.build_from_flow(
    ...
    output="./week_2/src/deployment/prefect-docker-deployment-web-to-gcs-green",
)
